...
def _init_auth_db():
    ...
    with _db_connect() as conn:
        ...
        for column_sql in (
            ...
            f"ALTER TABLE users {_add_col} is_verified INTEGER NOT NULL DEFAULT 0",
            f"ALTER TABLE users {_add_col} perm_switch_zones INTEGER NOT NULL DEFAULT 0",
            f"ALTER TABLE users {_add_col} perm_manage_permissions INTEGER NOT NULL DEFAULT 0",
            f"ALTER TABLE users {_add_col} perm_can_edit INTEGER NOT NULL DEFAULT 0",
